...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Changes the original string, few strings involved (less memory?) ?
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # no I was trying this out before in irb!
  end
  ...
  #  end
  #end
  #the above may not be correct since it was not in the path_to_enlightenment.rb
