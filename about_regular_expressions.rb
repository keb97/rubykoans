...
class AboutRegularExpressions < Neo::Koan
  ...
  #not sure tbh. does the optimal thing for the time being hopefully it's globally optimal. that's one answer.
  ...
  #hmmm not sure. you can set the alternation yourself? seems important.
